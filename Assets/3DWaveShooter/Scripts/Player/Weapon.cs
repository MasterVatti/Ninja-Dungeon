...
public class Weapon
{
    ...
    public ProjectileScriptableObject
        projectile; //Projectile shot by the weapon.
    public AudioClip shootSFX; //Sound effect played when weapon is shot.
    public GameObject
        visualPrefab; //Weapon game object in the player's hands.
    public GameObject
        onPlayerVisual; //The already created visual that the player has.
    public GameObject
        droppedPickup; //Game object spawned when the weapon is dropped.
    ...
    public int
        nextUpgradeIndex; //Index for upgrades for the weapon's next upgrade.
