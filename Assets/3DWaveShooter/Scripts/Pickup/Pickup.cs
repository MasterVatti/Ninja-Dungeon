...
public class Pickup : MonoBehaviour
{
    ...
    public bool
        spreadAmmoAcrossAllWeapons; //Is the ammo spread out across all weapons?
    ...
    private float
        creationTime; //Used to make sure the player doesn't instantly pick their weapon up again after dropping it.
