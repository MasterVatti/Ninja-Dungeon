...
public class LevelDataScriptableObject : ScriptableObject
{
    ...
    [Tooltip(
        "Is this level locked at the start of the game? Requiring another level to be completed in order to play this one.")]
    public bool lockedAtStart;

    [Tooltip(
        "Level Data of the level that needs to be completed, in order for this one to be unlocked.")]
...
public class WaveBossData
{
    ...
    [Range(0.0f, 100.0f)]
    [Tooltip(
        "How far into the wave will the boss spawn? 0 = start, 100 = end, 50 = half way.")]
