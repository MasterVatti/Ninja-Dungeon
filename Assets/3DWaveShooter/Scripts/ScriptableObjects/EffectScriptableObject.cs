...
public class EffectScriptableObject : ScriptableObject
{
    ...
    [Tooltip(
        "Temporarily change entity's stat for the duration of the effect.")]
...
public class ExplosiveOptions
{
    ...
    [Tooltip(
        "Does the damage drop off from 100% to 0% across the explosive range?")]
...
public class TempStatChange
{
    ...
    [Tooltip(
        "Modifier applied to entity's stat (0.5 = half, 1.0f = normal, 2.0 = double, etc).")]
